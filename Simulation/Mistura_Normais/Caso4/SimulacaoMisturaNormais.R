...
setwd("/home/cleber/Dropbox/Dissertacao-Cleber/Simulacao/R/Simulacao 17⁄11⁄2013/MisturaNormais/Caso4/")

#############  Impressao dos resultados  #################

## Saindo tabela
write.table(round(rbind(Rho_Gama,media_rho_mc,media_rho_ch,media_rho_sp),4),file="EstimativaMisturaCaso4.csv"
            ,row.names=FALSE,sep=";",dec=".",col.names=c("10","50","100","250","500"))
write.table(round(rbind(vies_rho_mc,vies_rho_ch,vies_rho_sp),4),file="ViésMisturaCaso4.csv"
            ,row.names=FALSE,sep=";",dec=".",col.names=c("10","50","100","250","500"))
write.table(round(rbind(var_rho_mc,var_rho_ch,var_rho_sp),4),file="VarianciaMisturaCaso4.csv"
            ,row.names=FALSE,sep=";",dec=".",col.names=c("10","50","100","250","500"))
write.table(round(rbind(raiz_eqm_rho_mc,raiz_eqm_rho_ch,raiz_eqm_rho_sp),4),file="ReqmMisturaCaso4.csv"
            ,row.names=FALSE,sep=";",dec=".",col.names=c("10","50","100","250","500"))


### Gerando os graficos boxplot
setwd("/home/cleber/Dropbox/Dissertacao-Cleber/Simulacao/Graficos/colorido/Simulacao 17⁄11⁄2013/MisturaNormais/Caso4/")  
save.image("RhoMistura.Rdata")
load("~/Dropbox/Dissertacao-Cleber/Simulacao/Graficos/colorido/Simulacao 17⁄11⁄2013/MisturaNormais/Caso4/RhoMistura.Rdata")
library(reshape2)
library(ggplot2)
